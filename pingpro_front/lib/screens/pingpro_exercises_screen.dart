    ...
    return SafeArea(
      child: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            Expanded(child: Text('Ejercicios', style: TextStyles.title, textAlign: TextAlign.center)),
          ]),
        ),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Text(label, style: TextStyle(color: AppColors.textBlack, fontWeight: FontWeight.bold)),
        ),
      ),
    );
  }
